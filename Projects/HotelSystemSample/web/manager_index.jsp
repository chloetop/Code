    ...
    <body>
        ...
        <table style=" width: 100%; height: 100%;border: 0pt none">
            ...
            <tr style="height: 350px">
                ...
                <td align="centre">
                    <fieldset>
                        <legend>Reception Management</legend>
                                ...
                                <table style="width: 100%">
                                    ...
                                    <tr>
                                        <td colspan="2" align ="center">
                                            <input type="button" value="OK" id="btOK" name="btOK" style="width: 80px" onclick="btOK2()"/>
                                            <input type="button" value="Clear" id="clear" name="clear" style="width: 80px" onclick="clear2()"/>
                                        </td>
                                    </tr>
                                </table>
                            </form>
