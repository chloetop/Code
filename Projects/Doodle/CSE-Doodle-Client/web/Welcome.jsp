        ...
        <script language="javascript">
            ...
            function ajaxfun(dataobj,strurl){
                ...
                $.ajax( { 
                    ...
                    success : function(data) {  
                        // alert(data); 
                        $("#p1").html("<a href=\"http://localhost:8080/CSE-Doodle-Client/Polls/"+data.trim()+"\">http://localhost:8080/CSE-Doodle-Client/Polls/Rate</a>");   
                    },  
                    error : function() {  
            ...
            function Createpoll(){
                ...
                showmess();
                setTimeout(ajaxfun(poll,"<%=session.getAttribute("Url").toString().trim()%>Polls/"),3000);      
                        
                //ajaxfun(poll,"<%=session.getAttribute("Url").toString().trim()%>Polls/");
            }
            function Next3(){
        ...
        <div id="wrapper">  
            ...
            <article id="art1">        
                ...
                <div class="text small  ">        
                    <div1 id="Layer1" style="display:block;z-index:1;font-family: 'Finger Paint', serif; font-size: 25px;  " ><a href="javascript:Schedule();" ><h4>Schedule an event</h4></a></div1>
                    <br />
                    <div align="left">
                        <img src="images/Number_001.png" width="50" height="50" alt="Number_001" /> <label style="font-size: 25px;font-family: 'Finger Paint', serif; width:60px" >Create Poll</label>
                        <br />
                        &nbsp;&nbsp;&nbsp;<img src="images/down.png" width="25" height="25" alt="next"/>
                        <br />
                        <img src="images/Number_002.png" width="50" height="50" alt="Number_002" /><label style="font-size: 25px;font-family: 'Finger Paint', serif; width:60px" >Invite Participants</label>
                        <br />
                        &nbsp;&nbsp;&nbsp;<img src="images/down.png" width="25" height="25" alt="next"/>
                        <br />
                        <img src="images/Number_003.png" width="50" height="50" alt="Number_003" /><label style="font-size: 25px;font-family: 'Finger Paint', serif; width:60px" >Confirm</label>
                    </div>
                </div>   
            </article>
            ...
            <article id="art5" style=" display: none">        
                ...
                <div class="line short "></div>        
                <div class="text large  ">
                    <img src="images/success.jpg" width="50px" height="50" alt="letter" /><label style="font-size: 25px;font-family: 'Finger Paint', serif;">Your poll has been created.</label>
                    </br>
                    <div1 id="p1"></div1>
                </div>
            </article>
